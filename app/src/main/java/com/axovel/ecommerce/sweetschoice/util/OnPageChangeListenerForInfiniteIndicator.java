    ...
    private void loadIndicators() {
        ...
        if (pageIndicatorList.size() < 1) {
            for (RequestResponse banner : bannerList) {
                ...
                imageView.setImageResource(R.drawable.ic_candy_unselected);// normal indicator image
        ...
        for (int x = 0; x < pageIndicatorList.size(); x++) {
            ...
            imageView.setPadding(0,0,0,2);
            imageView.setImageResource(x == positionToUse ? R.drawable.ic_candy_selected :
                    R.drawable.ic_candy_unselected); // active and notactive indicator
